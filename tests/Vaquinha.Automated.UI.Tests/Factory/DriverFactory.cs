...
namespace Vaquinha.AutomatedUITests
{
	public class DriverFactory
    {
        ...
        {
            // Inicializa o browser utilizando o ChromeDriver que está no caminho /users/amadeu/driver
            ChromeDriverService service = ChromeDriverService.CreateDefaultService("/users/amadeu/driver");
            //FirefoxDriverService service = FirefoxDriverService.CreateDefaultService("/users/amadeu/driver");
